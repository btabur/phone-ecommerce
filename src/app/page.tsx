        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-0 -top-20 hidden lg:block">
                <img src="/snake-1.png" className="w-full" />
              </div>
              <h1 className="relative w-fit tracking-tight text-balance mt-16 font-bold !leadind-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
          ...
          px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit ">
            <div className="relative md:max-w-xl">
              ...
              hidden sm:block lg:hidden xl:block" alt="" />
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6 ">
            ...
            font-bold text-5xl md:text-6xl text-gray-900">
              What our <span className="relative px-2">customers <Icons.underline className="hidden 
              sm:block pointer-events-none absolute inset-x-0 -bottom-6 text-green-500"/></span>  say</h2>
        ...
        <MaxWidthWrapper className="py-24">
            ...
            <div className="mx-auto max-x-6xl px-6 lg:px-8">
              <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
                  ...
                  -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0" alt="" />
                  ...
                  max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                    ...
                    shadow-2xl ring-1 ring-gray-900/10 h-full w-full " alt="" />
                  </div>
            ...
            <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
                ...
                <div className="flex justify-center">
                  ...
                  Crate your case now <ArrowRight className="h-4 w-4 ml-1.5"/>
                  </Link>
                </div>
            </ul>
        </MaxWidthWrapper>
